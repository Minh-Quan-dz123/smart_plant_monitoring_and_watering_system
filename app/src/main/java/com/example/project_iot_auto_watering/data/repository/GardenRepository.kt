...
class GardenRepository(private val api: ApiService) {
    ...
    suspend fun startIrrigation(gardenId:Int,durationManual: DurationManual,token:String): ReceiveIrrigationManual{
    ...
    suspend fun updateIrrigationMode(gardenId: Int,mode: ModeIrrigation,token: String): ReceiveIrrigationManual{
